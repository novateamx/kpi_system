...
public class JwtUtil {
    ...
    // so'z = maxfiy soz,   kalit = alisher, algotihm = AES, 1212sdfsf^5%sfdsfsdfs
    ...
    // bu yerda me JWT ni ozini default dagi claims larini ishlatganman
//    agar custom qilmoqchi bolsak bu ozgaradi
